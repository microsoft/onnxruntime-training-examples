...
class FastBertAttention(nn.Module):
    ...
    def forward(self, input_tensor, attention_mask):
        ...
        multi_head_attention_output,_ = self.multi_head_attention(query = input_tensor, key = input_tensor, value = input_tensor, key_padding_mask=attention_mask, need_weights=True,attn_mask = None, is_training = True)
...
class BertPreTrainedModel(nn.Module):
    ...
    def from_pretrained(cls, pretrained_checkpoint, state_dict=None, cache_dir=None,
                        from_tf=False, config_file=None, use_fast_mha=False, *inputs, **kwargs):
        """
        ...
        assert config_file, "BERT configuration file must be provided to from_pretraining()"
        config = BertConfig.from_json_file(config_file)
        config.fast = use_fast_mha
        ...
        if from_tf:
            ...
            return load_tf_weights_in_bert(model, pretrained_checkpoint, use_fast_mha=use_fast_mha)

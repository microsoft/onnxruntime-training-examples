...
class pretraining_dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # ORTModule needed as_tuple=False to checkpoint correctly
...
def setup_training(args):
    ...
    print("local_rank = {}, allreduce_post_accumulation = {}, n_gpu = {}".format(args.local_rank,
...
def prepare_model_and_optimizer(args, device):
    ...
    # Flexible API is taking over from now on
...
def main():
    ...
    if args.do_train:
        ...
        while True:
            ...
            # TODO: Removed all dist training support due to ORTMOdule limitation
                ...
                for step, batch in enumerate(train_iter):
                    ...
                    if global_step >= args.max_steps or training_steps % (
                        ...
                        if is_main_process() and not args.skip_checkpoint:
                            ...
                            if args.do_train:
                                if args.fp16 or args.local_rank != -1:
                                    master_params_list = list(amp.master_params(optimizer))
                                else:
                                    # ORTModule doesnt like APEX amp yet
                                    master_params_list = list(my_master_params(optimizer))
                                torch.save({'model': model_to_save.state_dict(),
                                            'optimizer': optimizer.state_dict(),
                                            'master params': master_params_list,

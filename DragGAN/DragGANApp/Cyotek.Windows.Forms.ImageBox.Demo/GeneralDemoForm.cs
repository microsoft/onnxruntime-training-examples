...
namespace Cyotek.Windows.Forms.Demo
{
    ...
    public partial class GeneralDemoForm : BaseForm
    {
        #region Fields

        private Image _previewImage;
        //private SegmentedImage m_image;
        private Bitmap m_region_layer;
        private string m_region_tooltip;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //m_image = new SegmentedImage();
            ////m_image.Load(@"c:\t\ran.jpg");
            ////m_image.Load2(@"C:\T\captures\2023-01-01--12-25-23\Image_FBMaskformer\original.png", @"C:\T\captures\2023-01-01--12-25-23\Image_FBMaskformer\labels.png");
            //m_image.Load2(@"C:\T\captures\2023-01-08--22-59-31\Image_FBMaskformer\original.png", @"C:\T\captures\2023-01-08--22-59-31\Image_FBMaskformer\labels.png");

            this.FillZoomLevels();
            //this.OpenImage(Resources.Sample);
            this.OpenSegmentedImage();
        ...
        //private void DrawImage(Graphics graphics, Color color, RectangleF rectangle, double scale, Bitmap image)
        //{
        //    float penWidth;
        ...
        //    })
        //    {
        //        graphics.DrawImage(m_image.ImageFilter(), rectangle);
        //        //graphics.DrawImage(image, rectangle);

        //        graphics.DrawImage(image, imageBox.GetImageViewPort(), imageBox.GetSourceImageRegion(), GraphicsUnit.Pixel);
        //    }
        ...
        private void imageBox_MouseLeave(object sender, EventArgs e)
        {
            ...
            //this.UpdateCursorPosition(new Point(99999, 99999));
            imageBox.Invalidate();
        ...
        private void imageBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (showImageRegionToolStripButton.Checked)
            {
                ...
                //if (m_region_layer != null)
                //{
                //    this.DrawImage(e.Graphics, Color.CornflowerBlue, imageBox.GetImageViewPort(), 1, m_region_layer);
                //}
        ...
        private void OpenSegmentedImage()
        {
            //imageBox.Image = m_image.Image();
            imageBox.ZoomToFit();
        ...
        private void UpdateCursorPosition(Point location)
        {
            ...
            if (!fitCursorLocationToBoundsToolStripMenuItem.Checked || imageBox.IsPointInImage(location))
            {
                ...
                //var r = m_image.Region(point.X, point.Y);
                //m_region_layer = r.CatImage;
                //m_region_tooltip = string.Format(r.CatName);
                //toolTip1.SetToolTip(imageBox, m_region_tooltip);
                //toolTip1.Active = true;
                //toolTip1.InitialDelay = 0;
            }
            else
            {
                toolTip1.SetToolTip(imageBox, "");
                cursorToolStripStatusLabel.Text = string.Empty;
            }
        }

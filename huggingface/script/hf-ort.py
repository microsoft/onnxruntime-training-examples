...
base_args_dict = {
    ...
    "distilbert-base" : ['--model_name_or_path', 'distilbert-base-uncased', '--num_train_epochs', 1, '--max_train_samples', 1000, '--dataset_name', 'wikitext', '--dataset_config_name', 'wikitext-2-raw-v1', '--do_train', '--max_steps', 500, '--logging_steps', 200, '--output_dir', '/tmp/test-mlm-bbu', '--overwrite_output_dir', '--per_device_train_batch_size', model_batchsize, '--fp16'],

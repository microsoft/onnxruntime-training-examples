...
base_args_dict = {
    ...
    "gpt2" : ['--model_name_or_path', 'gpt2', '--dataset_name', 'wikitext', '--max_train_samples', '100', '--dataset_config_name', 'wikitext-2-raw-v1', '--do_train', '--label_smoothing', 0.1, '--max_steps', args.max_steps, '--logging_steps', 200, '--overwrite_output_dir', '--output_dir', '/tmp/test-clm', '--per_device_train_batch_size', model_batchsize, '--fp16'],
